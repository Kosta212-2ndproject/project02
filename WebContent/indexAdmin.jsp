...
<body>
	...
	<div class="hero-wrap" style="background-image: url('images/company.jpg');" data-stellar-background-ratio="0.5">
			...
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-8 ftco-animate d-flex align-items-end">
					<div class="text w-100 text-center">
						<h1 class="mb-4">
							<span>Admin</span> <span>Page</span>.
						</h1>
						<p>
							<a href="#" class="btn btn-primary py-2 px-4">2조 재밌조</a>
							<a href="#" class="btn btn-white btn-outline-white py-2 px-4">Presentation</a>
						</p>
					</div>
				</div>
			</div>
