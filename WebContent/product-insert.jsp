...
<BODY>
	...
	<form name="writeForm" method="post" action="${path}/front?key=prod&methodName=insert" onSubmit='return checkValid()' enctype="multipart/form-data">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 mb-5 ftco-animate">
						<p align="right">
							<b><span style="font-size: 15pt;">*파일첨부</span></b>
						</p>
						<b><span style="font-size: 9pt;"> <input type="file" name="file" maxlength="60" size="40">
					...
					<div class="col-lg-6 product-details pl-md-5 ftco-animate">
						<h3>
							Name:
							<input type=text name="prodName" size="17">
							<br>
							<br>NameEng:
							<input type=text name="prodNameEng" size="20">
						</h3>
						


						<p class="price">
							<span style="font-size: 15pt">Price : <input type=text name="prodPrice" size="5">원
							</span>
						</p>
						<p>
							Type : <b> <input type="radio" name="prodType" value="Red" checked>Red&nbsp; <input type="radio" name="prodType" value="Sparkling">Sparkling&nbsp; <input type="radio" name="prodType" value="White">White&nbsp;
							</b> <br>
							<br> Nation : <b><select name="prodNation">
							...
							<br> Winery : <b><input type=text name="prodWinery" size="10"> / <input type=text name="prodWineryEng" size="15"></b> <br>
							<br>Vintage : <b><input type=text name="prodVatage" size="5"></b> <br>
							<br>Alcohol : <b><input type=text name="prodAlcohol" size="5"></b><br>
							<br> Sweet : <b><input type=text name="prodSweet" size="5"></b>
						...
						<p>
							<input type="submit" value="상품등록" class="btn btn-primary py-3 px-5 mr-2">
						...
						<div class="tab-content bg-light" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
								<div class="p-4">
									...
									<p>
										<textarea name="prodDetail" cols="120" rows="15"></textarea>
									</p>
							...
							<div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
								<div class="p-4">
									...
									<p>
									<h5>Taste :</h5>
									<textarea name="prodTaste" cols="120" rows="10"></textarea>
									<br>
									<br>
									<h5>Food matching :</h5>
									<textarea name="prodMach" cols="120" rows="1"></textarea>
									</p>
								</div>
							</div>
