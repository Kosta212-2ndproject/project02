   ...
   <div class="container">
      <div class="row">
         <div class="col-md-9">
            ...
            <div class="row">
               <c:choose>
                  <c:when test="${empty requestScope.listKeyWord}"><!-- requesScope에 저장해야 하는 이름이 list -->
                  </c:when>
                  <c:otherwise>
                     <c:forEach items="${requestScope.listKeyWord}" var="prodDto">
                        <div class="col-md-4 d-flex">

                           <div class="product ftco-animate">

                              <div class="img d-flex align-items-center justify-content-center"
                                   style="background-image: url('${prodDto.prodImgUrl}');">
                                 <div class="desc">
                                    <p class="meta-prod d-flex">
                                       ...
                                       <a href="${path}/front?key=prod&methodName=selectByProductDetail&prodId=${prodDto.prodId}"
                              ...
                              <div class="text text-center">
                                 ...
                                 <span class="price"><fmt:formatNumber value="${prodDto.prodPrice}"
                                                                       pattern="#,###원"/></span>
                              </div>
