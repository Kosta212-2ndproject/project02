    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<br><br>Vintage : <b>${prod.prodVatage}</b><br><br>Alcohol : <b>${prod.prodAlcohol}</b><br><br> Sweet : <b>${prod.prodSweet}</b>
          	...
          	<p><a href="front?key=prod&methodName=updateForm&prodId=${prod.prodId}" class="btn btn-primary py-3 px-5 mr-2">수정하기</a>
          	<a href="front?key=prod&methodName=deleteProduct&prodId=${prod.prodId}" class="btn btn-primary py-3 px-5">삭제하기</a></p>
    			</div>
    		</div>
