...
function checkValid() {
    ...
    var f = window.document.uploadForm;
...
<br>
<br>
<form name="uploadForm" method="post" action="${path}/front?key=notice&methodName=insert" 
...
<table align="center" cellpadding="5" cellspacing="2" width="600" border="1" >
    ...
    <tr>
        <td width="150" height="20" >
            <p align="right"><b><span style="font-size:9pt;">글제목 </span></b></p>
        </td>
        <td width="450" height="20"><b><span style="font-size:9pt;">
		<input type=text name="nTitle" size="30"></span></b></td>
    </tr>
     <tr>
        <td width="150" height="20">
        ...
        <td width="450" height="20"><b><span style="font-size:9pt;">
		<textarea name="nContent" cols="50" rows="10"></textarea></span></b></td>
    </tr>
        <tr>
        <td width="150" height="20">
     ...
     <tr>
        ...
        <td width="450" height="20">
        	<b><span style="font-size:9pt;">
        		 <input type="file" name="nImage" maxlength="60" size="40">
        	   </span></b>
        </td>
    </tr>
    <tr>
