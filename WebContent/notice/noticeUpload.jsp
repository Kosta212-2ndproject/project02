...
<BODY>
	...
	<form name="uploadForm" method="post"
		action="${path}/front?key=notice&methodName=insert"
		...
		<table align="center" cellpadding="5" cellspacing="2" width="600"
			...
			<tr>
				<td width="150" height="20">
					<p align="right">
						<b><span style="font-size: 9pt;">글제목 </span></b>
					</p>
				</td>
			...
			<tr>
				...
				<td width="450" height="20"><b><span
						style="font-size: 9pt;"> <input type="radio" name="nField"
							value="0" size="30" checked="checked">공지 <input
							type="radio" name="nField" value="1" size="30">이벤트 <input
							type="radio" name="nField" value="2" size="30">FAQ
					</span></b></td>
			</tr>
			<tr>
				<td width="150" height="20">
